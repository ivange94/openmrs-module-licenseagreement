...
public class LicenseAgreementModuleServiceImpl extends BaseOpenmrsService implements LicenseAgreementModuleService {
	 ...
	 */
	public void setDao(LicenseAgreementModuleDao dao) {
		this.dao = dao;
	}
